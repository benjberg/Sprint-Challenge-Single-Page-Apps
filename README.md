...
Some benefits of client-side routing is that it takes less downloaded data to display new components and it can reuse DOM elements. It's great for SPAs because you never have to leave the site.  
